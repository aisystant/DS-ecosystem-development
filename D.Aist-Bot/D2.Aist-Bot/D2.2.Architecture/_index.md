...
# D2.2. Архитектура Aist Bot

> **Тип:** Governance (специфика проекта Aist Bot)
>
> Этот раздел содержит архитектурные решения специфичные для Aist Bot.
> Pack-контент не требуется — это реализация конкретного бота.
...
| Документ | Назначение |
|----------|------------|
| [01-modes.md](01-modes.md) | Режимы работы: Марафон и Лента |
| [02-marathon-structure.md](02-marathon-structure.md) | Структура 14-дневного Марафона |
