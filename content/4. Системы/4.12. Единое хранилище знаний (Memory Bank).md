...
**Ключевые отличия от текущей версии в этом репозитории:**
 ✅ **Горизонтальное масштабирование** (шардирование, реплики для чтения)    
 ✅ **Развёртывание в нескольких регионах** (задержка <100 мс по всему миру)    
 ✅ **Стек наблюдаемости** (метрики, логи, трассировки, оповещения)    
 ✅ **CI/CD** (непрерывная интеграция/непрерывное развертывание) с автотестами и канареечным развёртыванием    
 ✅ **Ограничение скорости** (rate limiting) и **управление квотами** для агентов    
 ✅ **Оптимизация затрат** (холодное хранение, сжатие, время жизни данных (TTL))    
 ✅ **Рабочие процессы команды** (моно-/мульти-репозитории, инфраструктура как код (IaC), дежурство (on-call))
