...
**Рубрика** — набор критериев с весами для оценки ответа студента.
...
|----------|-----|----------|
| **Ключевая идея** | 40% | Студент передал ключевую идею из материала |
...
| Критерий | Вес | Описание |
|----------|-----|----------|
| **Понимание проблемы** | 30% | Студент понял суть вопроса/проблемы |
  ...
  rubric_conceptual_understanding:
    ...
    criteria:
      - id: main_idea
        name: "Ключевая идея"
        weight: 40
        description: "Студент передал ключевую идею"
        levels:
          - score: 40
...
3. **Понятность** — студент понимает, за что снижен балл
