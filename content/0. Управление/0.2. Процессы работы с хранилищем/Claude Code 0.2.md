...
Этот документ описывает техническую сторону работы Claude Code — как устроен контекст, расход токенов и стратегии их экономии при работе с хранилищем экосистемы.
...
| **CLAUDE.md** | Проектные инструкции, загружаются автоматически |
...
- [[CLAUDE.md]] — инструкции для Claude Code в проекте
