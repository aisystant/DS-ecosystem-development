...
updated: 2025-12-20
links:
  - path: "content/3. Экосистема развития (Система создания)/3.2. Архитектура — Платформа и подсистемы/2.2.3. Deterministic-IT-Systems/3.2.3.1. Цифровой двойник/MCP-сервер цифрового двойника 3.2.md"
    note: "MCP Twin — взаимодействие с персональными данными"
  - path: "content/3. Экосистема развития (Система создания)/3.2. Архитектура — Платформа и подсистемы/2.2.3. Deterministic-IT-Systems/Централизованное хранилище 3.2.md"
