...
| # | Артефакт | Ссылка |
|---|----------|--------|
| 1 | **Шаблон IWE** (GitHub) | [github.com/aisystant/FMT-exocortex-template](https://github.com/aisystant/FMT-exocortex-template) |
| 2 | **Этот документ** (PDF) | Справочник: протоколы, шаблоны, ссылки |
| 3 | **LEARNING-PATH** (11 разделов) | `docs/LEARNING-PATH.md` в шаблоне |
| 4 | **Бот @aist_me_bot** | [@aist_me_bot](https://t.me/aist_me_bot) |
| 5 | **MCP-сервер знаний** (5 400+ док.) | `https://knowledge-mcp.aisystant.workers.dev/mcp` |
| 6 | **MCP исходный код** (open source) | [github.com/aisystant/knowledge-mcp](https://github.com/aisystant/knowledge-mcp) |
...
| Архитектурным предложением | АрхГейт: ЭМОГССБ, порог ≥8 |
