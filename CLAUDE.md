...
**Правило:** Pack-контент (модели, методы, характеристики) хранится в Pack-репозиториях (source-of-truth).
В ecosystem-development остаётся governance-контент со ссылками на Pack.

| Ядро | Source-of-truth | Что в Pack |
|------|-----------------|------------|
| A (Созидатель) | spf-personal-pack | Модели, характеристики, состояния |
| B (Экосистема) | spf-ecosystem-pack | Модель экосистемы, компоненты |
...
|--------------|---------------|---------|
| Формализованное знание | Pack (source-of-truth) | Модели, методы, характеристики |
