...
## 5. Процессы поддержания артефактов

### 5.1. Обновление архитектурных диаграмм (WP-158, WP-159)

> Тип: внутренний процесс
> Владелец: архитектор (при изменении WP-73)
> Участники: WP-73, WP-158 (C4), WP-159 (Deployment)

**Триггер:** любое из следующих событий в WP-73:
- Принят новый ADR
- Добавлен/удалён сервис или подсистема
- Изменился хостинг (Railway, Hetzner, CF Worker и др.)
- Изменилась топология развёртывания (RU/EU ноды, новый контейнер)

**Действие:**
1. В той же сессии, где принято архитектурное решение → обновить WP-158 (C4-диаграммы) и/или WP-159 (Deployment-диаграмму)
2. Если изменение затрагивает только один из артефактов — обновить только его
3. Коммит вместе с изменением WP-73

**Выход:** Актуальные диаграммы, синхронизированные с текущей архитектурой

> **Примечание:** WP-158 и WP-159 не требуют отдельных РП на обновление после первоначального создания — поддерживаются этим процессом.
