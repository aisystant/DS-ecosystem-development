...
└── C3.Platform-Dev-Team/            # Система создания (входит в B3)
    ...
    ├── C3.2.Architecture/           # Состав команды, DevOps
...
└── D3.Dev-Team/                # Система создания (команда разработки)
    ├── D3.1.Meaning/           # Миссия команды в контексте бота
...
- D3 (Dev-Team) = та же система создания, что и C3
...
Команды-и-сообщества (A1) ∋ Созидатель (A2)
                    ...
                    Система-создания-Экосистемы (B3)
                                    │
                                    └─ ⊃ Dev-Team (C3/D3) → создаёт → ИТ-платформа (C2), Бот (D2)
```
