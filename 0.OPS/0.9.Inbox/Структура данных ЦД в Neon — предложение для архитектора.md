...
| **`finance` — отдельная schema** | Баланс токенов — не характеристика созидателя, а операционный показатель платформы. Роялти, подписки, платежи — отдельный bounded context со своим аудитом. В DP.ARCH.003 согласованы 5 проекций ЦД — token_balances среди них нет |
...
Ровно 5 проекций, согласованных в DP.ARCH.003. Каждая — отдельная таблица, пересчитывается из Events.
