...
- [x] ADR-014: Трёхосевая модель доступов (DP.D.034) — Permission = Entitlement ∩ Role ∩ Scope (ЭМОГССБ 8.7)
...
| P13 | **Permission = Entitlement ∩ Role ∩ Scope** (ADR-014, DP.D.034) | Три оси доступа: Тир (что доступно), Роль (что можно делать), Scope (над чем). «Админ-1 vs Админ-2» = одна роль, разный scope |
...
| ADR-014 | **Трёхосевая модель доступов** (DP.D.034) | ✅ Принято | Permission = Entitlement ∩ Role ∩ Scope. Zanzibar-стиль ReBAC. ORY Kratos + Keto/Neon | ЭМОГССБ 8.7 |

**Требуют юридического решения:** Q9 (152-ФЗ), Q11 (санкции), Q14 (юрлица).
**Требуют архитекторского согласования:** Q1, Q2, Q4, Q13.

### ADR-014: Трёхосевая модель доступов (DP.D.034)

> **Статус:** ✅ Принято. **ЭМОГССБ:** 8.7/10. **Source-of-truth:** `DP.D.034-access-control-model.md` в PACK-digital-platform.
