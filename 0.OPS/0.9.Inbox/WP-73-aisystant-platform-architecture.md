...
| 7 | **Activity Hub** (расширен 29 мар) | **Платформенный журнал событий.** Фиксирует ВСЕ события на платформе (бот, LMS, клуб, Billing, CRM, ORY, Web App). pg_notify — внутренний механизм уведомления подписчиков. Source для ЦД, баллов, дашбордов |
