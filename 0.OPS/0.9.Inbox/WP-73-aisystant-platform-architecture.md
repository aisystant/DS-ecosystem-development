...
| **Архитектор-29мар** | **RLS** (Q1), **pg_notify** все события (Q4), **ORY репликация** не федерация (Q2), **ORY Keto** для доступов (Q5), **Vue + раздельные хостинги** (Q3), **LMS не трогаем** — новая архитектура рядом (Q7), Vercel KV не нужен (Q8) | `WP-73-architect-agenda.md` | — |
...
| ADR-009 | **Event Bus: pg_notify + Neon, ВСЕ события** | ✅ | Фиксировать все события на платформе. pg_notify + Neon. Решение 29 мар | Q4 |
...
| Q4 | Event Bus | ✅ **pg_notify + Neon** (29 мар). Фиксировать ВСЕ события. TODO: типология входов/выходов, retention |
