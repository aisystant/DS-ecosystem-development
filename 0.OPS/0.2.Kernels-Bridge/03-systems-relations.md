...
- **B1.Society ∋ B2.Экосистема** — мир (EdTech-индустрия) содержит экосистему
...
- **B3.Система-Создания ⊃ C3.Platform-Dev-Team** — система создания включает ИТ-службу
...
- **C3.Platform-Dev-Team → C2.ИТ-Платформа** — ИТ-служба разрабатывает платформу
...
C1.Экосистема
  ∋
C2.ИТ-Платформа ← C3.Platform-Dev-Team
```
...
**Дополнительно**: B3.Система-Создания ⊃ C3.Platform-Dev-Team
...
B1.Society
  ∋
B2.Экосистема (= A3) ← B3.Система-Создания ⊃ C3.Platform-Dev-Team
  ⊃                                             ↓
C2.ИТ-Платформа ←────────────────────────────── C3
  ∋
...
C3.Platform-Dev-Team → C2.ИТ-Платформа
────────────────────────────────
C3.Platform-Dev-Team → B2.Экосистема (частично, через C2)
```
...
**Цепочка**:
```
B1.Society ∋ B2.Экосистема ← B3.Система-Создания ⊃ C3.Platform-Dev-Team → C2.Платформа
```
