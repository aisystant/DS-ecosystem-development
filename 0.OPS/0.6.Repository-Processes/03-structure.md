...
A1.Команды-и-сообщества ∋ A2.Созидатель
                           ↑
                           |
B1.Society → B2.Экосистема-развития ⊃ (Сообщество ∋ созидателей, ИТ-платформа)
                           ↑
                           |
                        B3.Система-создания-Экосистемы ⊃ C3.Platform-Dev-Teamу
                           ↑
                           |
...
├── B1.Society/                          # Надсистема (рынок EdTech/Creator Economy)
...
└── C3.Platform-Dev-Teamа/                    # Система создания (входит в B3)
...
- `C3.Platform-Dev-Teamа/` — система создания в ядре C
...
| `content/1.Мир/1.1.Смыслы/` | `B1.Society/B1.1.Meaning/` + `A1.Команды-и-сообщества/A1.1.Meaning/` |
...
| `content/3.Экосистема/3.3.Операции/` | `A3.Экосистема-развития/A3.3.Operations/` + `B3.Система-создания-Экосистемы/B3.3.Operations/` + `C3.Platform-Dev-Teamа/C3.3.Operations/` |
